...
// 消息响应回调
DataProtocol.prototype._emitResponse = function (mid, data) {
  var callback = this._msgCallback[mid];
  if (typeof callback !== 'function') return;
  this._debug('msg callback: mid=%s, data=%s', mid, data);
  callback(null, data);
};
...
DataProtocol.prototype.sendResponse = function (mid, data, callback) {
  this._debug('response to: mid=%s, data=%s', mid, receiver, data);
